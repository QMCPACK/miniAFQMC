...
template<typename T>
void transpose(Kokkos::View<T**> &a)
...
template<typename T>
void product(T alpha, Kokkos::View<T**> &a, Kokkos::View<T*> &x, T beta, Kokkos::View<T*> y)
...
template<typename T>
void product(Kokkos::View<T**> &a, Kokkos::View<T*> &x, Kokkos::View<T*> y)
// Kokkos::View<T*> product(Kokkos::View<T**> &a, Kokkos::View<T*> &x, Kokkos::View<T*> y)
{
  product(1.0, a, x, 0.0, y);
...
template<typename T>
void product(T alpha, Kokkos::View<T**> &a, Kokkos::View<T**> &b, T beta, Kokkos::View<T**> &c)
