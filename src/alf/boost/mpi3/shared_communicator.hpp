...
private:
	...
	inline shared_communicator(communicator const& comm, int key = 0){
        ...
        // MAM
        //inline shared_communicator(): communicator() {}
